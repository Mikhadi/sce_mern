...
export = (io:Server<DefaultEventsMap, DefaultEventsMap, DefaultEventsMap>, 
    ...
    const getAllPosts = async (payload) => {
        try{
            const res = await postController.getAllPosts(new NewRequest(payload, socket.data.user, null, null))
    ...
    const getPostById = async (payload) => {
        try{
            const res = await postController.getPostById(new NewRequest(payload, socket.data.user, null, payload.id))
    ...
    const getPostBySender = async (payload) => {
        try{
            const res = await postController.getAllPosts(new NewRequest(payload, socket.data.user, payload.sender, null))
    ...
    const addNewPost = async (payload) => {
        try {
            const res = await post.addNewPost(new NewRequest(payload, socket.data.user, null, null) )
    ...
    const updatePost = async (payload) => {
        try {
            const res = await post.updatePost(new NewRequest(payload, socket.data.user, payload.sender, payload.id) )
